/* dsl-execute.c
 * This file implements all the dsl funcitons as well as execution entry points into dsl.
 */
#include <string.h>
#include "dsl.h"
...
/***************************DSL STATIC VARS**********************************/
// TODO: FIXME: These need to be migrated to general checks.
...
static int32_t *compareval = NULL;
static int8_t ifptr = 0;
