...
//  DUAL  CLR / FGR     DUAL  CLR / GLD     DUAL  CLR / PRE     DUAL  CLR / PSI
    A_U | A_C | A_F,    A_U | A_C / A_G,    A_U | A_C | A_P,    A_U | A_C | A_S,
//  DUAL  CLR / RNG     DUAL  CLR / THF
    A_U | A_C | A_R,    A_U | A_C | A_T,
...
//  DUAL  DRU / FGR     DUAL  DRU / GLD     DUAL  DRU / PRE     DUAL  DRU / PSI
    A_U | A_D | A_F,    A_U | A_D | A_G,    A_U | A_D | A_P,    A_U | A_D | A_S,
//  DUAL  DRU / THF
    A_U | A_D | A_T,
...
//  CLR / FGR     CLR / PRE     CLR / PSI     CLR / RNG     CLR / THF
    A_C | A_F,    A_C | A_P,    A_C | A_S,    A_C | A_R,    A_C | A_T,
...
//  DRU / FGR     DRU / PRE     DRU / PSI     DRU / THF
